...
- When modifying `skills/triton-npu-optimize-submit-baseline/references/contract.json` or `skills/triton-npu-optimize-submit-round/references/contract.json`, rerun `python3 skills/triton-npu-optimize/script/update-artifacts.py` so `skills/triton-npu-optimize/references/artifacts.md` stays in sync.

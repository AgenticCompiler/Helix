...
- CANN extension API pattern cards under `skills/triton-npu-cann-ext-api-patterns/references/patterns/` follow the same card format and are also generated. Regenerate with: `uv run python skills/triton-npu-cann-ext-api-patterns/scripts/build_pattern_index.py --patterns-dir skills/triton-npu-cann-ext-api-patterns/references/patterns --output skills/triton-npu-cann-ext-api-patterns/references/patterns/index.md`

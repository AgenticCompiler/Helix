...
- `pipeline-overlap-vec-between-loads` — inserts VEC computation between independent load groups; this pattern reorders the loads themselves to expose the gaps.

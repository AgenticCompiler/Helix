...
- Kernel-target optimize rounds: `compare-perf(baseline="baseline/<operator>_perf.txt", compare="opt-round-N/opt_<operator>_perf.txt", metric_source="kernel", case_weights="case_weights.json")`
...
- `case_weights` adds weighted average improvement and weighted geomean speedup using representative-case weights generated by `triton-npu-case-weighting`.

...
5. If the user also needs hotspot evidence or operator timing attribution, use [`../npu-profile-operator/SKILL.md`](../npu-profile-operator/SKILL.md) as a companion skill.

...
- `--case-weights <json>` adds weighted average improvement and weighted geomean speedup using representative-case weights generated by `triton-npu-case-weighting`.

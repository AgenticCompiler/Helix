...
Use this reference when `npu-analyze-round-performance` needs help turning profiling evidence and IR evidence into concrete potential optimization points.

...
_BASELINE_CONTRACT_PATH = (
    _SKILLS_ROOT / "ascend-npu-optimize-submit-baseline" / "references" / "contract.json"
)
        ...
        if current_round < final_round:
            ...
            result = _build_result(
                ...
                summary=_append_pass_issues_to_summary(
                    ...
                    f"Use the staged `ascend-npu-optimize-start-round` skill to open {next_round_name} "

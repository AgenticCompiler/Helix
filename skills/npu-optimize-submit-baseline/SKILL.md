---
name: npu-optimize-submit-baseline
...
- Baseline preparation belongs to `npu-prepare-optimize-baseline`.
- Open-ended optimization work belongs to `{language}-npu-optimize`.

...
Align constexpr tile dimensions to the effective logical extent along each tiled axis, removing wasted masked iterations when lowered scalar-loop bounds exceed the actual workload.

...
- Skill links for OpenCode should be exposed under `.opencode/skills/<name>/SKILL.md`.
...
- Generalize the skill-link manager so it can prepare either Codex or OpenCode workspace skill directories.

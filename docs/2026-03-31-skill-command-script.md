...
- Add a bundled helper script under `skills/scripts/` so skills can invoke the current project CLI without requiring the `triton-agent` console script to be installed.
...
- Place the script at `skills/scripts/run-command.py`.

...
- Local standalone `run-bench` paths should consistently honor `HELIX_BENCH_OUTPUT_DIR`, including parallel standalone case execution.
...
- `HELIX_BENCH_OUTPUT_DIR` remains the single local profiler retention control for benchmark profiling.

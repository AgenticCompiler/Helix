...
- Temporary local and remote profiler directories must still be cleaned up for failed and successful cases, except when local artifact retention is explicitly enabled through `TRITON_AGENT_BENCH_PROFILE_OUTPUT_DIR`.

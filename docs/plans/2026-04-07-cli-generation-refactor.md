...
**Goal:** Move the remaining generation flow for `gen-test` and `gen-bench` out of `src/helix/cli.py` while preserving current CLI behavior.
...
**Files:**
- Create: `src/helix/generation.py`
- Modify: `src/helix/cli.py`
- Test: `tests/test_generation_commands.py`

- [ ] **Step 1: Move generation output-path and overwrite logic into `src/helix/generation.py`**

- [ ] **Step 2: Move generation request construction and runner invocation into `src/helix/generation.py`**
...
**Files:**
- Create: `src/helix/commands/generation.py`
- Modify: `src/helix/commands/__init__.py`
- Modify: `src/helix/cli.py`
- Modify: `tests/test_cli.py`

- [ ] **Step 1: Add `handle_gen_test` and `handle_gen_bench` in `src/helix/commands/generation.py`**

- [ ] **Step 2: Update `src/helix/cli.py` to dispatch generation commands through the new handler**

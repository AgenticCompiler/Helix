...
**Files:** `skills/triton-npu-run-eval/scripts/test_runner.py`, `skills/triton-npu-run-eval/scripts/compare_result_payloads.py`
...
**Status:** Fixed. The comparison helper now lives in `skills/triton-npu-run-eval/scripts/compare_result_payloads.py`, and `test_runner.py` reuses that shared implementation for both local and remote compare flows.
...
### `skills/triton-npu-run-eval/scripts/compare_result_payloads.py`
...
$ uv run --group dev ruff check tests/test_test_runner.py tests/test_remote_execution.py skills/triton-npu-run-eval/scripts/test_runner.py skills/triton-npu-run-eval/scripts/compare_result_payloads.py
All checks passed!

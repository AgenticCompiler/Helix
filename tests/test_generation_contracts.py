...
class GenerationContractTests(unittest.TestCase):
    ...
    def test_benchmark_generation_specs_use_hooked_standalone_contract(self) -> None:
        ...
        self.assertNotIn("--operator-file", standalone)
        self.assertNotIn("argparse", standalone)
        ...
        self.assertNotIn("--operator-file", msprof)
        self.assertNotIn("argparse", msprof)
        ...
        self.assertIn("**Warmup:** run the selected benchmark case **5 times**", msprof)
        self.assertIn("**Repeat:** after warmup, run the selected benchmark case **50 times**", msprof)

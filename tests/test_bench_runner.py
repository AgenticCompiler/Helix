    ...
    def test_run_local_bench_standalone_parallel_uses_isolated_case_workdirs_and_device_envs(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            def _fake_buffered_process(
                ...
                self.assertIn("run_one_bench_case_record", command[2])
                self.assertEqual(
                    command[3:],
                    [
                        bench_file.name,
...
def run_one_bench_case_record(bench_file, operator_file, case_id, preserved_run_dir=None, verbose=False):
...
""",
    ...
    def test_run_remote_bench_standalone_uses_module_helper_files(self) -> None:
        ...
        self.assertIn("run_local_bench", remote_command[2])

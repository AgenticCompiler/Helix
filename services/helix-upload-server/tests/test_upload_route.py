...
from helix_upload_server.app import create_app
    ...
    def test_same_slug_replaces_old_upload(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            resp2 = self._upload(
                client,
                headers_overrides={
                    "X-Helix-Upload-Uid": "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
                    "X-Helix-Upload-Timestamp": "20260526T141600Z",
                },
            )
    ...
    def test_different_slugs_dont_trigger_dedup(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            resp2 = self._upload(
                client,
                headers_overrides={
                    "X-Helix-Workspace-Slug": "other_workspace",
                    "X-Helix-Workspace-Name": "other_workspace",
                    "X-Helix-Upload-Uid": "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
                },
            )
            assert resp2.status_code == 200
    ...
    def test_burst_rate_limit_rejects_after_threshold(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            resp = self._upload(
                client,
                headers_overrides={
                    "X-Helix-Workspace-Slug": "slug_a",
                    "X-Helix-Workspace-Name": "slug_a",
                    "X-Helix-Upload-Uid": "a1" + "0" * 30,
                },
            )
            assert resp.status_code == 200
            ...
            resp = self._upload(
                client,
                headers_overrides={
                    "X-Helix-Workspace-Slug": "slug_b",
                    "X-Helix-Workspace-Name": "slug_b",
                    "X-Helix-Upload-Uid": "b2" + "0" * 30,
                },
            )
            assert resp.status_code == 200
            ...
            resp = self._upload(
                client,
                headers_overrides={
                    "X-Helix-Workspace-Slug": "slug_c",
                    "X-Helix-Workspace-Name": "slug_c",
                    "X-Helix-Upload-Uid": "c3" + "0" * 30,
                },
            )
            ...
            resp = self._upload(
                client,
                headers_overrides={
                    "X-Helix-Workspace-Slug": "slug_d",
                    "X-Helix-Workspace-Name": "slug_d",
                    "X-Helix-Upload-Uid": "d4" + "0" * 30,
                },
            )
            assert resp.status_code == 429

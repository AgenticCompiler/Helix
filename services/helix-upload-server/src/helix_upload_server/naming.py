...
def validate_upload_headers(headers: dict[str, str]) -> dict[str, str]:
    ...
    required = {
        "x-helix-upload-uid": "upload_uid",
        "x-helix-upload-timestamp": "upload_timestamp",
        "x-helix-workspace-name": "workspace_name",
        "x-helix-workspace-slug": "workspace_slug",
        "x-helix-manifest-version": "manifest_version",
    }
    result: dict[str, str] = {}

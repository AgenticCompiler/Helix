...
from helix.trace.core import trace_path_from_request
from helix.terminal.verbose import emit_verbose_lines

if TYPE_CHECKING:
    from helix.backends.claude_trace import ClaudeJsonOutputFilter
...
class ClaudeRunner(AgentRunner):
    ...
    def build_command(self, request: AgentRequest) -> list[str]:
        ...
        if request.enable_agent_hooks:
            command.extend(["--settings", str(request.workdir / ".claude" / "helix-hooks" / "settings.json")])

...
_THINKING_ENV = "HELIX_SHOW_OUTPUT_THINKING"
...
def build_claude_trace_env(
    ...
    *,
    ...
    env["HELIX_OTEL_TRACE_PATH"] = str(trace_path)
    env["HELIX_OTEL_RUN_ID"] = run_id
    env["HELIX_WORKSPACE_ROOT"] = str(workspace_root)
    return env

    ...
    *,
    ...
    return [
        ...
        *(
        ...
        "If `case_weights.json` exists in the workspace, include it in every round performance comparison with `compare-perf --case-weights case_weights.json` and use the weighted summary when judging representative-case impact.",
        "If representative-case performance improves but weighted metrics are weak or negative, treat that as evidence that the selected benchmark cases do not represent the full case distribution well.",

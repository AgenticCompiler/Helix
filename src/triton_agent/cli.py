...
_TOP_LEVEL_EXAMPLES = (
    "triton-agent gen-test -i kernel.py --language tilelang",
    "triton-agent convert -i kernel.py --language tilelang",
    "triton-agent convert-batch -i kernels --language tilelang",
    ...
    "triton-agent log-check-batch -i kernels --language tilelang",
    "triton-agent optimize -i kernel.py --agent codex --language tilelang",
    "triton-agent diff-skills-update -i kernels --agent codex --language tilelang",
    ...
    (
        ...
        (
            ...
            (
                ...
                "Recent comparable round count for advisory local-optimum warnings in npu-optimize-submit-round (default: 3).",
            ),
            (
